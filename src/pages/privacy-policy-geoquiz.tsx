  ...
  <main>
    <div className="min-h-screen px-8 md:px-32 pt-12 max-w-5xl m-auto">
      ...
      <h1 className="text-4xl md:text-6xl font-bold mb-6 text-center text-blue-700">
        Privacy Policy Geoquiz
      </h1>
      <p className="text-lg mb-6 text-gray-700 leading-relaxed">
        Geoquiz, (hereinafter "we", "our", or "us") respects the privacy of its
        users (hereinafter "user", "you", or "your") and is committed to
...
export default PrivacyPolicyGeoquiz;
